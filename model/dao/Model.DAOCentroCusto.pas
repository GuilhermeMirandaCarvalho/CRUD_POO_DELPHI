...
begin
  ...
  try
    FConexao
    .SQL('DELETE FROM CENTRO_CUSTO WHERE CENTRO_CUSTOID=:CENTRO_CUSTOID')
    .Params('CENTRO_CUSTOID',FCentroCusto.Centro_CustoId)
    .ExecSQL;
  except on e:Exception do
...
begin
  ...
  try
    FConexao
      .SQL('INSERT INTO CENTRO_CUSTO (CODIGO) VALUES (:CODIGO)')
      .Params('CODIGO', FCentroCusto.Codigo)
      .ExecSQL;
  except on e:Exception do
...
begin
  ...
  FDataSet :=
    FConexao
      .SQL('SELECT * FROM CENTRO_CUSTO WHERE CENTRO_CUSTOID=:CENTRO_CUSTOID')
      .Params('CENTRO_CUSTOID',FCentroCusto.Centro_CustoId)
      .Open
      .DataSet;
end;
